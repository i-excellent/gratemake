...
use app\models\search\SearchTrade;
use yii;
        ...
        return [
            ...
            'access' => [
                ...
                'rules' => [
                    [
                        'allow'   => true,
                        'actions' => ['profile', 'account', 'networks',
                            'disconnect', 'delete','my-good','history','cash'],
                        'roles'   => ['@'],
                    ],
                    [
                        'allow'   => true,
